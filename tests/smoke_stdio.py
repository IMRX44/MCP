...
async def main(live: bool) -> int:
    ...
    async with stdio_client(params) as (read, write), ClientSession(read, write) as session:
        ...
        if init.serverInfo.version != __version__:
            print(
                f"  FAIL handshake version: expected {__version__}, "
        ...
        except Exception as exc:  # noqa: BLE001 - unknown-tool behavior varies by SDK
